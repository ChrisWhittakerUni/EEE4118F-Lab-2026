...
LDiskLBrake = timeseries(ServoMotorDataLightDisk.Motor_vel, ServoMotorDataLightDisk.Time);
%LDiskHBrake = timeseries(ServoMotorDataLightDisk.Motor_vel, ServoMotorDataLightDisk.Time);
HDisk = timeseries(ServoMotorDataLightDisk.Motor_vel, ServoMotorDataLightDisk.Time);
